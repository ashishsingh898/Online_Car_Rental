...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=LAPTOP-GOBSLSRA\\SQLEXPRESS;Initial Catalog=CAR_RENT;Integrated Security=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Booking>(entity =>
            {
                entity.HasKey(e => e.RentId)
                    .HasName("PK__BOOKING__76A8EE5580B89A7C");
                ...
                entity.HasOne(d => d.Car)
                    ...
                    .HasConstraintName("FK__BOOKING__CAR_ID__1B9317B3");

                entity.HasOne(d => d.EmailNavigation)
                    .WithMany(p => p.Bookings)
                    .HasForeignKey(d => d.Email)
                    .HasConstraintName("FK__BOOKING__EMAIL__1C873BEC");
            });
            ...
            modelBuilder.Entity<Cart>(entity =>
            {
                ...
                entity.HasOne(d => d.Car)
                    .WithMany(p => p.Carts)
                    .HasForeignKey(d => d.CarId)
                    .HasConstraintName("FK__CART__CAR_ID__0F2D40CE");

                entity.HasOne(d => d.EmailNavigation)
                    .WithMany(p => p.Carts)
                    .HasForeignKey(d => d.Email)
                    .HasConstraintName("FK__CART__EMAIL__0E391C95");
            });

            modelBuilder.Entity<Contactu>(entity =>
            {
                entity.HasKey(e => e.ContactusId)
                    .HasName("PK__CONTACTU__83191CE967C317F7");
                ...
                entity.HasOne(d => d.EmailNavigation)
                    ...
                    .HasForeignKey(d => d.Email)
                    .HasConstraintName("FK__CONTACTUS__EMAIL__1209AD79");
            });

            modelBuilder.Entity<Signin>(entity =>
            {
                entity.HasKey(e => e.LoginId)
                    .HasName("PK__SIGNIN__476A024D5F561AAB");
                ...
                entity.HasOne(d => d.EmailNavigation)
                    ...
                    .HasForeignKey(d => d.Email)
                    .HasConstraintName("FK__SIGNIN__EMAIL__0697FACD");
            });

            modelBuilder.Entity<Signup>(entity =>
            {
                entity.HasKey(e => e.Email)
                    .HasName("PK__SIGNUP__161CF72521C2D8B0");
